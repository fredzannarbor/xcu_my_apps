...
def argparse_handler():
    ...
    argparser.add_argument('--docxfile', help='path to text file', default='editorial/Syzmanski/Outer_Space_Warfare_Foreign_Perspectives-2022-01-18_1_.docx')
    ...
    argparser.add_argument('--output_filename', help='output file name - user should provide extension', default='textfile.txt')

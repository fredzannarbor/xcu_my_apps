...
def main():
    ...
    render_unified_sidebar(
        app_name="Social Xtuff - Profile",
        nav_items=[
            ("Social Feed", "pages/22_AI_Social_Feed.py"),
            ("Login/Register", "pages/24_Login_Register.py"),
        ]
    )
    ...
    # Sidebar Navigation (auth handled by unified sidebar)
    with st.sidebar:

    ...
    if not st.session_state.username:
        ...
        if st.button(get_translation(st.session_state.language, "proceed_checkout"),
            ...
            try:
                ...
                logger.info(f"[STRIPE DEBUG] success_url being sent to Stripe: {success_url}")
...
if "success" in query_params:
    ...
    # Clear only the success query params, keep the page on /6_Bookstore
    # Remove success params but stay on current page
    ...
    # Note: session_id is preserved for auth continuity

...
client = OpenAI(
    api_key=api_key,  # Replace with your xAI API key
    base_url=base_url  # Hypothetical xAI API base URL; adjust as needed
)
...
def get_act(chapter):
    if chapter.startswith("Chapter"):
        chapter_num = int(chapter.split()[1].split(":")[0])
        if chapter_num <= 5:
            return "Act 1"
        elif 6 <= chapter_num <= 11:
            return "Act 2"
        else:
            return "Act 3"
    else:
        return "Act 3"  # default case

# Function to generate scene_configs (Part 1: Up to Chapter 8)
def generate_scene_configs():
    ...
    # Educational elements progression
...
# Scene configurations
    ...
    scene_configs["User Feedback"] = {
        ...
        "character_details": f"{CHARACTER_DETAILS['Maya Chen (GroguGirl)']}, {CHARACTER_DETAILS['Maria Gonzalez']}",
        "plot_details": "Maya observes staff using platform, collects feedback; Maria visits, offers valuable user perspective.",
        "knowledge_theme": THEMATIC_STAGES["Act 3"]["knowledge"],
        "prejudice_theme": THEMATIC_STAGES["Act 3"]["prejudice"],
        "tech_theme": THEMATIC_STAGES["Act 3"]["tech"],
        "family_theme": THEMATIC_STAGES["Act 3"]["family"],
    ...
    scene_configs["School Presentation"] = {
        ...
        "character_details": f"{CHARACTER_DETAILS['Maya Chen (GroguGirl)']}, {CHARACTER_DETAILS['Olivia Kim']}",
        "plot_details": "Maya presents data visualization to class, explains real-world use; gains confidence, Olivia sees her anew, teacher suggests mentoring.",
        "knowledge_theme": THEMATIC_STAGES["Act 3"]["knowledge"],
        "prejudice_theme": THEMATIC_STAGES["Act 3"]["prejudice"],
        "tech_theme": THEMATIC_STAGES["Act 3"]["tech"],
        "family_theme": THEMATIC_STAGES["Act 3"]["family"],
    ...
    scene_configs["The Future Discussion"] = {
        "setting": "Park near Chen family home",
        "characters": "Maya Chen, Alex Chen",
        "purpose": "Plan future goals",
        "character_details": f"{CHARACTER_DETAILS['Maya Chen (GroguGirl)']}, {CHARACTER_DETAILS['Alex Chen']}",
        "plot_details": "Maya and Alex walk, discuss careers; Maya wants to blend education and tech, they plan a coding camp for girls.",
        "knowledge_theme": THEMATIC_STAGES["Act 3"]["knowledge"],
        "prejudice_theme": THEMATIC_STAGES["Act 3"]["prejudice"],
        "tech_theme": THEMATIC_STAGES["Act 3"]["tech"],
        "family_theme": THEMATIC_STAGES["Act 3"]["family"],
    ...
    scene_configs["The New Beginning"] = {
        "setting": "DOGE headquarters",
        "characters": "Maya Chen",
        "purpose": "Show Maya’s new role and impact",
        "character_details": CHARACTER_DETAILS["Maya Chen (GroguGirl)"],
        "plot_details": "Maya in her advisor role, platform expands; watches citizens engage, reflects on growth, mentors a young visitor.",
        "knowledge_theme": THEMATIC_STAGES["Act 3"]["knowledge"],
        "prejudice_theme": THEMATIC_STAGES["Act 3"]["prejudice"],
        "tech_theme": THEMATIC_STAGES["Act 3"]["tech"],
        "family_theme": THEMATIC_STAGES["Act 3"]["family"],
    ...
    # Epilogue
    scene_configs["One Year Later"] = {
        "setting": "Award ceremony venue",
        "characters": "Maya Chen, Alex Chen, Elon Musk",
        "purpose": "Show long-term impact",
        "character_details": f"{CHARACTER_DETAILS['Maya Chen (GroguGirl)']}, {CHARACTER_DETAILS['Alex Chen']}, {CHARACTER_DETAILS['Elon Musk']}",
        "plot_details": "Maya receives an outreach award; platform in twelve departments, Alex in ethics role, Musk acknowledges success.",
        "knowledge_theme": THEMATIC_STAGES["Act 3"]["knowledge"],
        "prejudice_theme": THEMATIC_STAGES["Act 3"]["prejudice"],
        "tech_theme": THEMATIC_STAGES["Act 3"]["tech"],
        "family_theme": THEMATIC_STAGES["Act 3"]["family"],
    ...
    scene_configs["Looking Forward"] = {
        "setting": "Maya’s bedroom",
        "characters": "Maya Chen, Alex Chen",
        "purpose": "Inspire future possibilities",
        "character_details": f"{CHARACTER_DETAILS['Maya Chen (GroguGirl)']}, {CHARACTER_DETAILS['Alex Chen']}",
        "plot_details": "Maya works on a school data literacy project; she and Alex view a visualization of spreading knowledge, symbolizing impact.",
        "knowledge_theme": THEMATIC_STAGES["Act 3"]["knowledge"],
        "prejudice_theme": THEMATIC_STAGES["Act 3"]["prejudice"],
        "tech_theme": THEMATIC_STAGES["Act 3"]["tech"],
        "family_theme": THEMATIC_STAGES["Act 3"]["family"],
...
def generate_scene(chapter, scene_info, scene_configs):
    ...
    config = scene_configs.get(scene_name, {
        ...
        "character_details": f"{"Maya Chen (GroguGirl)"}",
    ...
    try:
        response = client.chat.completions.create(
            model="grok-2-1212",  # Hypothetical model name; replace with actual xAI model
            messages=[
    ...
    with open("Code_for_Change_Draft.md", "w", encoding="utf-8") as f:
        ...
        for chapter, scenes in CHAPTERS.items():
            ...
            for scene in scenes:
                ...
                scene_text = generate_scene(chapter, scene, scene_configs)
